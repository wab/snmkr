...
jQuery.fn.vectorMap('addMap','france_fr', {
	...
	"pathes": {
		"1":{
			"path":"M503.3,105.4l-5,3.9l-3.1,0.1l-5.8-2.6l-4-3.3h-7.7l-1.4,3.1l-6.3,0.8l-3.9-8.1l-3.5,0.3v-3.5l-6.8-1.7
		...
		"2":{
			"path":"M335.6,1l-18.3,4.6l-15.4,4.8l-6.5,5.6v20.2l3.3,3.9l-3.1-1.9l-0.8,6.6l0.5,4.3l2.6,1.8l-4.2,1.6l-0.4,3.4
		...
		"3":{
			"path":"M328.3,131.8l-2.5,1.8l-10.3-2.5l-7.1,2.1l-6.3-1.3l-1.8-3.6l-4.4,10.6h-4.3l-2.7,2.8l2,6.6l4.2,7.4
		...
		"4":{
			"path":"M422.4,215.5l-2.5,2.2l-3.301-1.5l-14.1,1.8l-5.6-12.3L392.8,201l-2.2,2.5l-2.8-9.3l-5-6.2l-4.1-1.7
		...
		"5":{
			"path":"M344.2,205.3l-10.3-0.8l3-1.7l0.6-3l-4.7-4.8l-0.8-3.5l-4.2-0.6l-3.1,1.9l-1.7-2.9l-2.1,3.1l-7.801,0.9l0,0
		...
		"6":{
			"path":"M342.6,304.3l-2.5,2.1l1.9,6l-1.9,2.7l-9.8,1.1l-3.899,6.7l0,0l1.199,4.4c2.801,1.8,5.601,3.6,8.301,5.5
			...
			"url": "auvergne-rhone-alpe"
		},
		"7":{"path":"M326.4,322.9l-5.5-0.2l-3.101,0.9l-14.9-3l-2.1,2.8l-12.9,1.2l-3.1,3.2l-1.9-2.7l-6.5,1.2l-3-1.2l1.8-3.2
		...
		"8":{
			"path":"M178.5,114l-6,2.6l-7.2-11.8l2.8-8.8l-1.2-3.1l-7.3-0.8l-2.8,2l-7.3,0.5l-12.8-5.2l-0.2,3.2l3.7,2l0.6,5.5
		...
		"9":{
			"path":"M114,161.8l-4,0.3l-12.1,10l-1-4.1l-4.5-2.9l-0.1-3.5l-5.1-8.8l-3.3-0.7l0.7-3.2l-3.4,0.4l-1.9,3.3l1.5-7.4
		...
		"10":{
			"path":"M144.2,225.8l-1.8,3.2l-14.7,0.5l-5.9,3.8l-0.4,6.7l-17.3,5.1l-5,4.9l2.7,6.9l6.8,1.2l2.3,2.2l5.5-4.1
		...
		"11":{
			"path":"M302,425.601l-7.6-6.801l-9,0.801l-0.8,5.699l-1.6,6l-5.1,3.601l0.8,4l-6.8,3.8l-5.3,7.2l-3.8,3.6l3,10.2
		...
		"12":{
			"path":"M558.1,425.4l-6.8-0.3l-5.899-3.7l-0.9-7.4l-3.1-0.1L538.8,408l0,0l-6.8,1.3l-2.3,2.2l-8.7-3.899l-1.7,4.3
			...
			"url" : "provence-alpes-cote-azur"
		},
		"13":{
			"path":"M569.8,578.9l0.601-12l-2-10.2l-3.2-1.2l-2.601,2.3l0.5,19.5l-9.699-1.5l-3.9,5.5l-12.1,4.801l-0.9,3.199
